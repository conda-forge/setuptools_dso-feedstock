About setuptools_dso-feedstock
==============================
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/setuptools_dso-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/setuptools_dso-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add setuptools_dso
# for installing globally
pixi global install setuptools_dso
```
...
It is possible to list all of the versions of `setuptools_dso` available on your platform:
...
```
pixi search setuptools_dso --channel conda-forge
```
